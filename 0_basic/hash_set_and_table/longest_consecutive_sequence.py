class Solution:  # https://leetcode.cn/problems/longest-consecutive-sequence/
    ...
    def longestConsecutive(self, nums: List[int]) -> int:
        ...
        res = 0
        for item in nums:  # 枚举中心点值 O(N) O(N) only traversed 1 time
            ...
            if item in unused:
                ...
                res = max(res, r - l - 1)
        return res
        # l = lc start num - 1, r = lc end num + 1    [1234] l=0, r=5
        # [100,4,200,1,3,2], item=4, l=3,r=5 -> l=0 r stay 5, final length 5-0-1=4 [1234]
