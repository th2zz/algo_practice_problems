class Solution:
    """  https://www.lintcode.com/problem/1300/?_from=collection&fromId=161
    EASY
You are playing the following game with your friend: There is a pile of stones on the table,
each time one of you take turns to remove 1 to 3 stones. The one who removes the last stone will be the winner. You will take the first turn to remove stones.
