# traverse end position of window, if not enough for window, continue, do operation from first window
# if enough for a window, do operation, consider for item eviction
class Solution:
    ...
    def containsNearbyDuplicate(self, nums: list[int], k: int) -> bool:
        ...
        for i in range(n):
            ...
            if nums[i] in window:  # seen, then there is duplicate
                return True
            window.add(nums[i])
        return False
